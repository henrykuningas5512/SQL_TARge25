...
--- transactioni näide, et mõlemad uuendatavad read 
--- peavad õnnestuma, et muudatused jääksid kehtima
...
--- muutsin esimese käsuga 9 TV peale,
-- aga ikka on 10 TV-d
...
--- non repeatable read probleemi lahendamiseks kasutatakse 
--- tran 1 ees:
--- set tran isolation level repeatable read
...
insert into Employee values(1, 'Makr')
...
--- vastuseks tuleb: Makr ja Sara. Marcust ei näita, aga peaks
